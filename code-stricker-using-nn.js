...
class Pod extends Unit {
    ...
    output(move) {
    	...
    	if (move.shield) {
    		...
    		print(this.checkPointX, this.checkPointY, move.thrust, ' ' + this.angle + ' ' + ' ' + move.angle + ' ' + move.thrust );
    	}
    }
...
while (true) {
    ...
    var checkpoint = new Checkpoint(checkpointId, nextCheckpointX, nextCheckpointY, 600);
